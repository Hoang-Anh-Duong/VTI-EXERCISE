...
import Assignment2.ExerciseOne.service.*;
import java.util.*;
	...
	void changeInfoEmployee(Employee employee) {
		...
		try {
			...
			if (type == 0) {
				...
				if (employee.getClass().getName() == "Assignment2.ExerciseOne.entity.SalariedEmployee") {
					...
					menu();
				} else if (employee.getClass().getName() == "Assignment2.ExerciseOne.entity.HourlyEmployee") {
